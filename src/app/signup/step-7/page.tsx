import SignUpStepSeven from '@/components/SignUpStepSeven';
import type { Metadata } from 'next';

export const metadata: Metadata = {
  title: 'Step 7 - Complete Registration - RAZ CAPITALS',
  description: 'Complete your RAZ CAPITALS registration and start trading.',
};
