    ...
    <div className="flex h-screen bg-[#0A2E1D] overflow-hidden">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <div className="flex-1 p-6 space-y-6 overflow-y-auto" style={{ backgroundColor: '#B8D4C1' }}>
          <div>
            <h2 className="text-2xl font-bold text-[#1E2E23] mb-2">Deposit Funds</h2>
            <p className="text-[#2D4A35]">Add funds to your trading account securely and instantly.</p>
          </div>

          {/* Account Selection */}
          <div className="bg-[#2D4A35] rounded-lg p-6">
            <h3 className="text-white text-lg font-medium mb-4">Select Account</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="bg-[#B8D4C1] rounded-lg p-4 cursor-pointer hover:bg-[#A0C8A9] transition-colors">
                ...
                <p className="text-[#1E2E23] font-bold mt-2">Balance: $25,000.00</p>
              </div>
              <div className="bg-[#B8D4C1] rounded-lg p-4 cursor-pointer hover:bg-[#A0C8A9] transition-colors">
                <h4 className="text-[#1E2E23] font-medium">Pro Trading Account</h4>
                <p className="text-[#2D4A35] text-sm">Account #: 1234567891</p>
                <p className="text-[#1E2E23] font-bold mt-2">Balance: $50,000.00</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-[#2D4A35] rounded-lg p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              <div className="bg-[#B8D4C1] rounded-lg p-4 text-center cursor-pointer hover:bg-[#A0C8A9] transition-colors">
                ...
                <p className="text-[#1E2E23] font-medium">Credit Card</p>
              ...
              <div className="bg-[#B8D4C1] rounded-lg p-4 text-center cursor-pointer hover:bg-[#A0C8A9] transition-colors">
                ...
                <p className="text-[#1E2E23] font-medium">Bank Transfer</p>
              ...
              <div className="bg-[#B8D4C1] rounded-lg p-4 text-center cursor-pointer hover:bg-[#A0C8A9] transition-colors">
                ...
                <p className="text-[#1E2E23] font-medium">PayPal</p>
                <p className="text-[#2D4A35] text-xs">Instant</p>
              </div>
              <div className="bg-[#B8D4C1] rounded-lg p-4 text-center cursor-pointer hover:bg-[#A0C8A9] transition-colors">
                <svg className="w-8 h-8 mx-auto mb-2 text-[#1E2E23]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <p className="text-[#1E2E23] font-medium">Cryptocurrency</p>
          ...
          {/* Deposit Form */}
          <div className="bg-[#2D4A35] rounded-lg p-6">
            <h3 className="text-white text-lg font-medium mb-6">Deposit Details</h3>
