      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <div className="flex-1 p-4 sm:p-6 space-y-4 sm:space-y-6 overflow-y-auto" style={{ backgroundColor: '#B8D4C1' }}>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3 sm:gap-4">
            <button className="bg-[#2D4A35] hover:bg-[#3A5642] rounded-lg p-4 sm:p-6 text-white transition-colors duration-200 flex flex-col items-center">
            ...
            <button className="bg-[#2D4A35] hover:bg-[#3A5642] rounded-lg p-4 sm:p-6 text-white transition-colors duration-200 flex flex-col items-center sm:col-span-3 lg:col-span-1">
              <div className="w-10 h-10 sm:w-12 sm:h-12 bg-[#A0C8A9] rounded-full flex items-center justify-center mb-2 sm:mb-3">
                <svg className="w-5 h-5 sm:w-6 sm:h-6 text-[#1E2E23]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
            ...
            <div className="bg-[#2D4A35] rounded-lg p-4 sm:p-6">
              <div className="flex justify-between items-center mb-4 sm:mb-6">
                <h2 className="text-white text-base sm:text-lg font-medium">Trading Accounts</h2>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                <div className="bg-[#B8D4C1] rounded-lg p-3 sm:p-4">
                  <div className="flex justify-between items-center mb-2">
                    <h3 className="text-[#1E2E23] text-xs sm:text-sm font-medium">Trading Accounts:</h3>
                    <a href="#" className="text-[#1E2E23] text-xs hover:underline">See All</a>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-[#1E2E23] text-xl sm:text-2xl font-bold">0</span>
                    <button className="bg-[#2D4A35] text-white px-2 sm:px-3 py-1 rounded text-xs font-medium hover:bg-[#3A5642] transition-colors">
                      Create Account
                    </button>
                  </div>
                </div>
                ...
                <div className="bg-[#B8D4C1] rounded-lg p-3 sm:p-4">
                  <div className="flex justify-between items-center mb-2">
                    <h3 className="text-[#1E2E23] text-xs sm:text-sm font-medium">Demo Accounts:</h3>
                    <a href="#" className="text-[#1E2E23] text-xs hover:underline">See All</a>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-[#1E2E23] text-xl sm:text-2xl font-bold">0</span>
            ...
            <div className="bg-[#2D4A35] rounded-lg p-4 sm:p-6">
              <div className="flex justify-between items-center mb-4 sm:mb-6">
                <h2 className="text-white text-base sm:text-lg font-medium">Recent Transactions</h2>
                <a href="#" className="text-[#A0C8A9] text-sm hover:text-white transition-colors">See All</a>
              </div>
              
              <div className="text-center text-[#A0C8A9]/60 py-6 sm:py-8">
