    ...
    <div className="flex h-screen bg-[#0A2E1D] overflow-hidden">
      ...
      <div className="w-64 bg-[#0F1B14] border-r border-[#A0C8A9]/20 flex flex-col">
        ...
        <div className="flex-1 overflow-y-auto">
          <nav className="px-4 py-6 space-y-2">
            ...
            <a href="/dashboard/wallets" className="flex items-center space-x-3 px-4 py-3 text-white bg-[#A0C8A9]/10 rounded-lg border-l-4 border-[#A0C8A9]">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <div className="flex-1 p-6 space-y-6 overflow-y-auto" style={{ backgroundColor: '#B8D4C1' }}>
          {/* Account Details */}
          <div>
            <h2 className="text-2xl font-bold text-[#1E2E23] mb-6">Account Details</h2>
          </div>

          {/* Account Cards */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {/* Account 1 */}
            <div className="bg-[#2D4A35] rounded-lg p-6 text-white relative">
              ...
              <div className="mb-4">
                ...
                <p className="text-3xl font-bold text-white">0 USD</p>
              </div>
            ...
            <div className="bg-[#2D4A35] rounded-lg p-6 text-white flex flex-col items-center justify-center text-center cursor-pointer hover:bg-[#3A5642] transition-colors">
              <svg className="w-12 h-12 text-[#A0C8A9] mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6v6m0 0v6m0-6h6m-6 0H6" />
              </svg>
              <p className="text-white font-medium text-lg">Open Additional Account</p>
            </div>
          </div>
          ...
          <div className="bg-[#2D4A35] rounded-lg p-6">
            ...
            {/* Table Header */}
            <div className="bg-[#1E2E23] rounded-t-lg">
              <div className="grid grid-cols-7 gap-4 p-4 text-[#A0C8A9] text-sm font-medium">
                <div>DESCRIPTION</div>
                <div>WALLET</div>
